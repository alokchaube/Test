...
@implementation SearchResultCellIpad
    ...
    reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _articlelabel.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleRightMargin;
        [self.contentView addSubview:_articlelabel];
        
                
        _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(11, 14, 700, 27)];
		_titleLabel.backgroundColor = [UIColor clearColor];
        _titleLabel.numberOfLines = 0;
        
		[_titleLabel sizeToFit];
        _titleLabel.textColor  = [UIColor colorWithRed:1/255.0 green:118/255.0 blue:195/255.0 alpha:1.0];
        [_titleLabel setAutoresizingMask:UIViewAutoresizingFlexibleRightMargin|UIViewAutoresizingFlexibleWidth];
