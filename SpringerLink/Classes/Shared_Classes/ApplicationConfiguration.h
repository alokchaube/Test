...
#define kCollapsedDescriptiveText @"The Journal of Materials Science publishes reviews, full-length papers, and short Communications recording original research results on, or techniques for studying the relationship between structure, properties, and uses of materials. "

#define kFullDescriptiveText @"The subjects are seen from international and interdisciplinary perspectives covering areas including metals, ceramics, glasses, polymers, electrical materials, composite materials, fibers, nanostructured materials, nanocomposites, and biological and biomedical materials. The Journal of Materials Science is now firmly established as the leading source of primary communication for scientists investigating the structure and properties of all engineering materials"
...
#define kHeaderSpringerText @"Springer Text"
#define kSpringerText @"Our business is publishing. Throughout the world, we provide scientific and professional communities with superior specialist information – produced by authors and colleagues across cultures in a nurtured collegial atmosphere of which we are justifiably proud."
